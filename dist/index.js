    ...
    if (messageReaction.emoji.name === '🅰️' || messageReaction.emoji.name === '🅱️' && user.id !== "722303830368190485") {
        ...
        if (user.client.guilds.cache
            ...
            if (messageReaction.emoji.name === '🅰️') {
                if (await (await db_1.getMatch(messageReaction.message.channel.id)).p2.userid === user.id && user.client.guilds.cache
                    .get(messageReaction.message.guild.id)
                    .members.cache.get(user.id)
                    .roles.cache.has("719936221572235295")
                    === false) {
                ...
                if (await (await db_1.getMatch(messageReaction.message.channel.id)).p1.userid === user.id && user.client.guilds.cache
                    .get(messageReaction.message.guild.id)
                    .members.cache.get(user.id)
                    .roles.cache.has("719936221572235295")
                    === false) {
        ...
        if (args[0].toLowerCase() === "help") {
            ...
            try {
                ...
                await message.channel.send(new Discord.MessageEmbed()
                    ...
                    .setColor("RED")
                    .setTitle("ERROR")
                    .addFields({ name: 'Channel Name', value: `${(await client.channels.fetch(message.channel.id)).name}`, inline: true }, { name: 'Channel Id', value: `${message.channel.id}`, inline: true }, { name: 'User', value: `${message.author.tag}`, inline: true }, { name: 'User Id', value: `${message.author.id}`, inline: true })
